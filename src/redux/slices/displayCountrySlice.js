...
export const displayCountrySlice = createSlice({
    ...
    reducers: {setDisplayCountry: (state, action) => {state.value = action.payload}, deleteDisplayCountry: (state) => {state.value = null}},

})

export const {setDisplayCountry, deleteDisplayCountry} = displayCountrySlice.actions

export const selectDisplay = (state) => {return state.displayedCountry.value}
